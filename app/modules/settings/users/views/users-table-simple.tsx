...
import {
  ...
  export function UsersTableSimple({
    ...
    function nextPage() {
      ...
      router.push(`${pathname}?pageNumber=${pageNumber+1}&offset=${offset}`, { scroll: false });
    }
        ...
        <CardFooter>
          <form className="flex items-center w-full justify-between">
            <div className="text-xs text-muted-foreground">
              Showing{' '}
              <strong>
                {Math.max(0, Math.min(offset - rowsPerPage, totalUsers) + 1)}-{offset}
              </strong>{' '}
            ...
            <div className="flex">
              ...
              <Button
                ...
                size="sm"
                type="submit"
                disabled={offset + rowsPerPage > totalUsers+1000}
              >
                Next

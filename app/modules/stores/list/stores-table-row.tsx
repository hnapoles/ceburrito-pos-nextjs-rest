    ...
    <TableRow>
      ...
      <TableCell>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>
                ...
                <button  onClick={()=> handleOpenDialog(store.name)} >Delete</button>
        ...
        <DialogContent>
            ...
            <DialogDescription>
                Are you sure you want to delete product <strong>{store.name}</strong> with _id <strong>{store._id}</strong>? 
            </DialogDescription>
            </DialogHeader>
            <DialogFooter>
            ...
            <Button variant="destructive" onClick={() => handleConfirmDelete(store.name)}>
                Confirm
            </Button>
            </DialogFooter>
        </DialogContent>
